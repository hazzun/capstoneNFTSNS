<template>
  <div>
    <div class="head-menus">
      ...
      <router-link
        to="/connect"
        class="head-connect align-center header-margin-l"
        v-if="!connected"
      >
        ...
        <div class="head-navs">
          ...
          >
            ...
            <div
              ...
              :class="language == 'English' ? 'active' : ''"
            >
              English
            </div>
            <div
              class="popover-menu-item"
              @click="languageSelect('中文')"
              :class="language == '中文' ? 'active' : ''"
            >
              中文
            </div>
          </el-popover>
...
export default {
  ...
  methods: {
    /**
     * 스크롤 위치에 따른 style 변화 (background 색상 변화)
     * 
    handleScroll() {
      let scrollTop =
        window.pageYOffset ||
      ...
      if (scrollTop) {
        if (scrollTop < 112) {
          this.style.backgroundColor = `rgba(255, 255, 255,${scrollTop /
            (scrollTop + 112)})`;
        } else {
